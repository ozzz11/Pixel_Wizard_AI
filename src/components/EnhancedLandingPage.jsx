...
const EnhancedLandingPage = () => {
  ...
  const translations = {
    ru: {
      ...
      getMonthly: "Купить ежемесячный план",
      getLifetime: "Купить ömür boyu план",
      downloadNote: "Примечание: RAR файл, пароль: pixelwizard",
    ...
    en: {
      ...
      monthly: "$18/month",
      lifetime: "$120 once",
      getMonthly: "Buy Monthly Plan",
      getLifetime: "Buy Lifetime Plan", 
      downloadNote: "Note: RAR file, password: pixelwizard",
    ...
    tr: {
      ...
      getMonthly: "Aylık Planı Satın Al",
      getLifetime: "Ömür Boyu Satın Al",
      downloadNote: "Not: RAR dosyası, şifre: pixelwizard",
      ...
      <section className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-6">
            <motion.a
              href="https://drive.google.com/file/d/1yUIQVdSzVxEicY8XbgqoMj-bLj5rVRpd/view?usp=drive_link"
              target="_blank"
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 flex items-center gap-3 shadow-2xl"
            >
          ...
          >
            <div className="text-center">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 rounded-lg font-semibold transition-all duration-300 block text-center"
              >
                {t.getMonthly}
              </a>
            </div>
          ...
          >
            ...
            <div className="text-center">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white py-3 rounded-lg font-semibold transition-all duration-300 block text-center"
              >
                {t.getLifetime}
              </a>
            </div>
